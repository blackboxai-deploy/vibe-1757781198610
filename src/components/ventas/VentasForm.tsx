...
const clientesDB = [
  { id: 'CLI001', nombre: 'María González', cedula: '1.234.567', telefono: '0981-123456', regimenTurismo: false },
  { id: 'CLI002', nombre: 'Carlos Mendoza', cedula: '2.345.678', telefono: '0985-234567', regimenTurismo: false },
  { id: 'CLI003', nombre: 'Ana Rodríguez', cedula: '3.456.789', telefono: '0976-345678', regimenTurismo: true },
  { id: 'CLI004', nombre: 'Roberto Silva', cedula: '4.567.890', telefono: '0971-456789', regimenTurismo: false },
  { id: 'CLI005', nombre: 'Lucia Benítez', cedula: '5.678.901', telefono: '0982-567890', regimenTurismo: true }
]
            ...
            {items.map((item) => (
              <div key={item.id} className="bg-white p-4 rounded-lg flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button onClick={() => removeItem(item.id)} className="text-red-600 hover:text-red-700 p-2">×</button>
                </div>
              </div>
            ))}
          </div>
      ...
      {showVehicleModal && pendingService && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Seleccionar Tipo de Vehículo</h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg max-w-2xl w-full">
            <div className="px-6 py-4 border-b border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900">🧾 Factura - {ventaCompletada.numeroFactura}</h3>
            </div>
            <div className="p-6">
